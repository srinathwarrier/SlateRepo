...
public class AddUserAsyncTask extends AsyncTask<Void,Void,Void>{
    ...
    public AddUserAsyncTask(String userName, String userEmail, String android_id, Context mContext)
    {
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            String urlStr= "https://slate-muzak.rhcloud.com/createNewUser.php?android_id='"+android_id+"'&name='"+userName+"'&email='"+userEmail+"'";
